package com.derren.tmon.lotto.util;
...
public class LottoResultTest {
    ...
    public void 일치하는_개수가_3개인지() {
        ...
        assertEquals(3, jackpot.match(new Lotteries(Arrays.asList(lotto)), new LottoNumber(40)).matchCount(lotto));
    }
    ...
    public void 일치하는_랭크_찾기() {
        Lotto jackpot = new Lotto("1, 2, 3, 4, 5, 6");
        Lotto lotto = new Lotto("1, 2, 3, 10, 20, 30");
        LottoRecorder lottoRecorder = jackpot.match(new Lotteries(Arrays.asList(lotto)), new LottoNumber(40));
    ...
    public void 수익() {
        ...
        LottoRecorder lottoRecorder = new LottoRecorder(new WinningLotto(jackpot, new LottoNumber(40)), lottoList);
    ...
    public void 수익률_계산() {
        ...
        LottoRecorder lottoRecorder = jackpot.match(lotteries, new LottoNumber(13));
    ...
    public void 행운_번호_일치_및_랭크별() {
        ...
        LottoRecorder lottoRecorder = jackpot.match(lotteries, new LottoNumber(7));
